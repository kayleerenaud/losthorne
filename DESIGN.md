...
- **UI zones are fixed so text never overlaps** ✅: dialogue bottom-center; notifications top-center only; potion status right side under the coins. The quest tracker is now SLIM — small, quiet, translucent, top-left. ✅ **No live progress counters** ✅ (Kaylee, 2026-07-04): the tracker shows a GOAL ("⚔️ Drive the goblins from the north woods"), never a running "3/5". Goblins simply keep attacking until you've cleared enough; a one-time "quest complete!" cue is the only tally. **Deliver quests SCOLD instead of counting** ✅: come back to Dorgan/Erik still short and they name the exact shortfall ("I still need 2 more 🔴 Red Berries — back to the bushes!") rather than showing a HUD fraction.
...
| **Jessie** | Traveling bard / storyteller *(one character — formerly written "Jesse"; unified 2026-07-04)* | A young **bard woman**. Travels across the whole map, so she brings NEWS — new islands, information, rumors. Like the mailman in Zelda, she approaches YOU — a breakaway moment. She *sings* her stories: music plays while the words appear on screen. Dresses more colorfully than everyone else — a **colorful dress with beads** and **tons of jewelry from different places on the map**. **ORIGIN (Kaylee 2026-07-04):** you first meet her **CURSED into the WITCH** (boss #1, §9); breaking the curse with Dorgan's antidote reveals her as Jessie. She thanks you and **promises to come to your aid when you most need it** — sealing her as a **recurring ally** important to the rest of the story. After the rescue she takes up her traveling-bard life across the map. 🔜 |
...
- **Smash** — a CHARGED strike: hold ~⅓s–2.4s then release = **mini smash**; hold the full **~2.4 seconds** = **FULL smash** (double damage, big radius). *(v0.22: eased from 3s → 2.4s — a full charge under fire was too strict; tuning guess, confirm w/ Kaylee.)* While charging you are ROOTED in place — that's the risk. A ring fills around you and flashes gold when the full smash is ready — and that "ready" moment now matches exactly when releasing gives the big one. **Before you own the shield**, holding the attack button charges the smash; **once you own the shield, smash charging lives ONLY on the 💥 context button.** ✅
...
- **Piranhas** 🔜 SPEC'D — mini water enemies. First appearance: the **boat crossing to the Witch's island** — they **leap onto your boat** and you kill each in **two hits**; a **SMASH cracks the hull** (so smashing them is a trap), and if the hull breaks you **swim the rest of the way**. (Also the Kraken's minions later, §9 boss 4.)

### Boss ladder (each in a different territory)
1. **The Witch** ✅ BUILT (Kaylee, 2026-07-05) — the second territory boss, in the **deep north woods**. Full arc, now playable end-to-end:
   - **Hook:** after the hammer lesson, **Dorgan runs wildly through the village** — a disturbance past the north woods, and he suspects the **WITCH**. He'll give a special potion recipe to whoever takes her down. The **Chief asks if you'll do it** — choice: **"I'll do it"** / **"I need more time to prepare."** The Chief reminds you to **stock up on FOOD** before this one.
   - **The potion (a mini-challenge at Dorgan's):** Dorgan takes you into his shop and teaches you to brew a **three-ingredient complex potion** — you must **make a fire first**, then **COOK it → MIX it → STIR it** (a small crafting minigame). Potion in hand, he sends you into the woods.
   - **The twist:** the potion **isn't for the player.** You may try to drink it — nothing happens, but it must feel *intentional*: *"This was never meant for YOU…"* It's the **antidote to cure the Witch** — the true way to beat her.
   - **The approach:** the Witch lives **deep in the woods**, surrounded by **goblins** and protected by a **single wolf pack**. **Goblins and wolves never attack at the same time** (alternate/aggro-gate them). Her **hut sits on an island in the middle of a lake** — you take a **boat** across.
   - **The piranha crossing:** **little piranhas jump onto the boat**; kill each (**two hits**). A **SMASH cracks the hull** — so you can't just smash-spam. If the **boat breaks, you swim the rest of the way** (ties into the swim system).
   - **The Witch fight:** inside the hut you see a **CAT** — harmless-looking, until it **SHAPESHIFTS**. The cat IS the Witch. Attack her and **she keeps shapeshifting into new animals** — your hits never defeat her — until you realize you must **use the POTION**. The **antidote's ingredients are hidden throughout her house**; gather them **while she attacks you** (you can **block with the shield or take hits, but her damage never lands** — the tension is the scramble, not death). **Throw the finished potion onto her** → the curse breaks.
   - **The reveal — JESSIE:** the Witch becomes **Jessie**, a young **bard woman** (see §5 cast). She **thanks you for breaking the curse** and promises **she'll come help you when you're in your most need** — her "gift" is a **promise of future aid** (she becomes a recurring ally, important to the rest of the story). *(Everything here is fresh canon from Kaylee 2026-07-04; tuning/appearance are placeholders.)*
...
- **THE WITCH ARC — BUILT** ✅ (Kaylee 2026-07-05; full mechanics in §9 boss #1). Deployed in story order across 6 stages. Chain order: **Bog (once home) offers the fishing trip → after fishing, offers to teach boating → Modo "hears from Bog" you brought back a hammer, jokingly offers to BUY it, then teaches the hammer (practice on dummies; hammer = SWING on tap + SMASH on charge)** → **Dorgan runs through the village** raving about a disturbance past the north woods — the WITCH — and offers a recipe to whoever'll stop her → **Chief asks: "I'll do it" / "I need more time to prepare"**, and reminds you to **stock up on FOOD** → **Dorgan's potion minigame** (make fire → cook → mix → stir a 3-ingredient antidote) → into the deep woods → goblins + one wolf pack (never both aggroing at once) → **piranha boat crossing** to the island hut → **shapeshifting cat-Witch**: gather the antidote's ingredients around her house while she harries you (damage never lands), then **throw the potion** → she becomes **JESSIE** the bard, who promises future aid. Stop there.
...
- **Fishing & boat-driving** ✅: learn to fish with Bog (adaptive coaching), and after your first catch he'll teach boat-driving **by putting YOU at the oars** ✅: a real full-screen crossing — a steady downstream **CURRENT** carries you on (no resting), you steer across it through a staggered **rock slalom**, and there are **STAKES**: the boat has a **3-plank HULL** (shown top-left) and each rock hit **CRACKS a plank**. Crack all three and the hull **SPLITS — you swamp back to the start dock** and Bog charges an **≤8-coin repair fee** (scolds if you're broke). Reach the FAR JETTY to bank boat-driving. *(current/rock-count/hull/fee = tuning guesses.)* **Later quests logged:** buying your OWN boat; the shipwreck rescue ("take my boat — save them!") that foreshadows the Kraken.
...
- Jessie's storytelling has its own music (she sings; the words appear on screen).
...
- ~~The Witch mini-boss: her mechanics and territory.~~ ✅ ANSWERED (Kaylee 2026-07-04) — see §9 boss #1 (deep-woods arc: Dorgan's antidote minigame, piranha boat crossing, shapeshifting cat-witch, Jessie reveal).
- Wisp behavior.
