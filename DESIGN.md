...
1. **The Witch** 🔜 SPEC'D (Kaylee, 2026-07-04) — the second territory boss, in the **deep north woods**. Full arc:
...
- **THE WITCH ARC — next to build** 🔜 (Kaylee 2026-07-04; full mechanics in §9 boss #1). Re-stated chain order she wants around here: **Bog (once home) offers the fishing trip → after fishing, offers to teach boating → Modo "hears from Bog" you brought back a hammer, jokingly offers to BUY it, then teaches the hammer (practice on dummies; hammer = SWING on tap + SMASH on charge)** → **Dorgan runs through the village** raving about a disturbance past the north woods — the WITCH — and offers a recipe to whoever'll stop her → **Chief asks: "I'll do it" / "I need more time to prepare"**, and reminds you to **stock up on FOOD** → **Dorgan's potion minigame** (make fire → cook → mix → stir a 3-ingredient antidote) → into the deep woods → goblins + one wolf pack (never both aggroing at once) → **piranha boat crossing** to the island hut → **shapeshifting cat-Witch**: gather the antidote's ingredients around her house while she harries you (damage never lands), then **throw the potion** → she becomes **JESSIE** the bard, who promises future aid. Stop there.
