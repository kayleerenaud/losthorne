...
| **Jessie** (a.k.a. Jesse) | Traveling bard / storyteller | Travels across the whole map, so she brings NEWS — new islands, new information, rumors. Like the mailman in Zelda, she approaches YOU, and it's a breakaway moment. She *sings* her stories — music plays while the words appear on screen. Dresses more colorfully than everyone else: a **colorful dress with beads** and **tons of jewelry from different places on the map**. 🔜 **ORIGIN (Kaylee 2026-07-04):** you first meet her **CURSED into the WITCH** (boss #1, §9). Breaking the curse with Dorgan's antidote reveals her as Jessie; she thanks you and **promises to come to your aid when you most need it** — a recurring ally seeded by this rescue. |
